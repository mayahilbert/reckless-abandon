...
function startGifBg() {
  ...
  const generateTiles = () => {
    ...
    // Calculate precise tile width from the real rendered container width
    const tileWidth = gridWidth / columns;
    const tileHeight = tileWidth * 0.8;

    // Use clientHeight of the container (which natively excludes scrollbars)
